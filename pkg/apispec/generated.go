...
type Client struct {
	...
	// paths in the apispec spec will be appended to the server.
	Server string
...
func NewGetSwaggerJsonRequest(server string) (*http.Request, error) {
	...
	operationPath := fmt.Sprintf("/apispec.json")
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
func RegisterHandlersWithBaseURL(router EchoRouter, si ServerInterface, baseURL string) {
	...
	router.GET(baseURL+"/apispec.json", wrapper.GetSwaggerJson)
...
// GetSwagger returns the content of the embedded apispec specification file
...
// a naive cached of a decoded apispec spec
