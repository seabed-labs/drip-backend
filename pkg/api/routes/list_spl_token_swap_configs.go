...
func (h Handler) GetSpltokenswapconfigs(c echo.Context, params apispec.GetSpltokenswapconfigsParams) error {
...
func findTokenSwapForVault(vault *repository.VaultWithTokenPair, vaultWhitelistsByVaultPubkey map[string][]*model.VaultWhitelist, tokenSwapsByTokenPairID map[string][]*repository.TokenSwapWithBalance) (*repository.TokenSwapWithBalance, error) {
