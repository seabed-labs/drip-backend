...
func (h Handler) GetV1DripPubkeyPathTokenmetadata(c echo.Context, pubkeyPath apispec.PubkeyPathParam) error {
	switch pubkeyPath {
	// USDT
	case "8ULDKGmKJJaZa32eiL36ARr6cFaZaoAXAosWeg5r17ra":
		fallthrough
	case "8Tq1poiHWnJvN1QbUJXGHqvsMvH6MPmjMzjJRP1KSpYY":
		return c.JSON(http.StatusOK, apispec.TokenMetadata{
			Collection: struct {
