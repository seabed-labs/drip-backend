...
type Position struct {
	...
	DepositedTokenAAmount    types.Decimal `boil:"deposited_token_a_amount" json:"deposited_token_a_amount" toml:"deposited_token_a_amount" yaml:"deposited_token_a_amount"`
	WithdrawnTokenBAmount    types.Decimal `boil:"withdrawn_token_b_amount" json:"withdrawn_token_b_amount" toml:"withdrawn_token_b_amount" yaml:"withdrawn_token_b_amount"`
	DepositTimestamp         time.Time     `boil:"deposit_timestamp" json:"deposit_timestamp" toml:"deposit_timestamp" yaml:"deposit_timestamp"`
	DcaPeriodIDBeforeDeposit types.Decimal `boil:"dca_period_id_before_deposit" json:"dca_period_id_before_deposit" toml:"dca_period_id_before_deposit" yaml:"dca_period_id_before_deposit"`
	NumberOfSwaps            types.Decimal `boil:"number_of_swaps" json:"number_of_swaps" toml:"number_of_swaps" yaml:"number_of_swaps"`
	PeriodicDripAmount       types.Decimal `boil:"periodic_drip_amount" json:"periodic_drip_amount" toml:"periodic_drip_amount" yaml:"periodic_drip_amount"`
...
var PositionColumns = struct {
	...
	Vault:                    "vault",
	Authority:                "authority",
	DepositedTokenAAmount:    "deposited_token_a_amount",
	WithdrawnTokenBAmount:    "withdrawn_token_b_amount",
	DepositTimestamp:         "deposit_timestamp",
	DcaPeriodIDBeforeDeposit: "dca_period_id_before_deposit",
	NumberOfSwaps:            "number_of_swaps",
	PeriodicDripAmount:       "periodic_drip_amount",
	IsClosed:                 "is_closed",
}
...
var PositionTableColumns = struct {
	...
	DepositedTokenAAmount:    "position.deposited_token_a_amount",
	WithdrawnTokenBAmount:    "position.withdrawn_token_b_amount",
	DepositTimestamp:         "position.deposit_timestamp",
	DcaPeriodIDBeforeDeposit: "position.dca_period_id_before_deposit",
	NumberOfSwaps:            "position.number_of_swaps",
	PeriodicDripAmount:       "position.periodic_drip_amount",
...
var PositionWhere = struct {
	...
	DepositedTokenAAmount    whereHelpertypes_Decimal
	WithdrawnTokenBAmount    whereHelpertypes_Decimal
	DepositTimestamp         whereHelpertime_Time
	DcaPeriodIDBeforeDeposit whereHelpertypes_Decimal
	NumberOfSwaps            whereHelpertypes_Decimal
	PeriodicDripAmount       whereHelpertypes_Decimal
	IsClosed                 whereHelperbool
}{
	Pubkey:                   whereHelperstring{field: "\"position\".\"pubkey\""},
	Vault:                    whereHelperstring{field: "\"position\".\"vault\""},
	Authority:                whereHelperstring{field: "\"position\".\"authority\""},
	DepositedTokenAAmount:    whereHelpertypes_Decimal{field: "\"position\".\"deposited_token_a_amount\""},
	WithdrawnTokenBAmount:    whereHelpertypes_Decimal{field: "\"position\".\"withdrawn_token_b_amount\""},
	DepositTimestamp:         whereHelpertime_Time{field: "\"position\".\"deposit_timestamp\""},
	DcaPeriodIDBeforeDeposit: whereHelpertypes_Decimal{field: "\"position\".\"dca_period_id_before_deposit\""},
	NumberOfSwaps:            whereHelpertypes_Decimal{field: "\"position\".\"number_of_swaps\""},
	PeriodicDripAmount:       whereHelpertypes_Decimal{field: "\"position\".\"periodic_drip_amount\""},
	IsClosed:                 whereHelperbool{field: "\"position\".\"is_closed\""},
}
...
type positionR struct {
	PositionVault *Vault `boil:"PositionVault" json:"PositionVault" toml:"PositionVault" yaml:"PositionVault"`
}
...
func (r *positionR) GetPositionVault() *Vault {
	if r == nil {
		return nil
	}
	return r.PositionVault
}
...
var (
	positionAllColumns            = []string{"pubkey", "vault", "authority", "deposited_token_a_amount", "withdrawn_token_b_amount", "deposit_timestamp", "dca_period_id_before_deposit", "number_of_swaps", "periodic_drip_amount", "is_closed"}
	positionColumnsWithoutDefault = []string{"pubkey", "vault", "authority", "deposited_token_a_amount", "withdrawn_token_b_amount", "deposit_timestamp", "dca_period_id_before_deposit", "number_of_swaps", "periodic_drip_amount", "is_closed"}
	positionColumnsWithDefault    = []string{}
	positionPrimaryKeyColumns     = []string{"pubkey"}
...
// PositionVault pointed to by the foreign key.
func (o *Position) PositionVault(mods ...qm.QueryMod) vaultQuery {
...
// LoadPositionVault allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for an N-1 relationship.
func (positionL) LoadPositionVault(ctx context.Context, e boil.ContextExecutor, singular bool, maybePosition interface{}, mods queries.Applicator) error {
	var slice []*Position
	var object *Position
	...
	if singular {
		...
		object.R.PositionVault = foreign
		if foreign.R == nil {
			foreign.R = &vaultR{}
		}
...
// SetPositionVault of the position to the related item.
// Sets o.R.PositionVault to related.
// Adds o to related.R.Positions.
func (o *Position) SetPositionVault(ctx context.Context, exec boil.ContextExecutor, insert bool, related *Vault) error {
	var err error
	if insert {
	...
	if o.R == nil {
		o.R = &positionR{
			PositionVault: related,
		}
	} else {
		o.R.PositionVault = related
	}
...
func FindPosition(ctx context.Context, exec boil.ContextExecutor, pubkey string, selectCols ...string) (*Position, error) {
	...
	query := fmt.Sprintf(
		"select %s from \"position\" where \"pubkey\"=$1", sel,
	)
...
func (o *Position) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	...
	if !cached {
		...
		if len(wl) != 0 {
			...
			cache.query = "INSERT INTO \"position\" %sDEFAULT VALUES%s"
		}
...
func (o *Position) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	...
	if !cached {
		...
		cache.query = buildUpsertQueryPostgres(dialect, "\"position\"", updateOnConflict, ret, update, conflict, insert)
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to upsert position")
	}
...
func (o *Position) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"position\" WHERE \"pubkey\"=$1"
...
func (o *Position) Reload(ctx context.Context, exec boil.ContextExecutor) error {
	ret, err := FindPosition(ctx, exec, o.Pubkey)
	if err != nil {
		return err
	}
...
func PositionExists(ctx context.Context, exec boil.ContextExecutor, pubkey string) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"position\" where \"pubkey\"=$1 limit 1)"
