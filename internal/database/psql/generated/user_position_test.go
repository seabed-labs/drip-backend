...
func testUserPositionsExists(t *testing.T) {
	...
	e, err := UserPositionExists(ctx, tx, o.Pubkey)
	if err != nil {
...
func testUserPositionsFind(t *testing.T) {
	...
	userPositionFound, err := FindUserPosition(ctx, tx, o.Pubkey)
	if err != nil {
		t.Error(err)
	}
...
var (
	userPositionDBTypes = map[string]string{`Pubkey`: `character varying`, `Mint`: `character varying`, `Amount`: `boolean`}
	_                   = bytes.MinRead
)
...
func testUserPositionsUpdate(t *testing.T) {
	...
	if len(userPositionAllColumns) == len(userPositionPrimaryKeyColumns) {
...
func testUserPositionsSliceUpdateAll(t *testing.T) {
	...
	var fields []string
	if strmangle.StringSliceMatch(userPositionAllColumns, userPositionPrimaryKeyColumns) {
		fields = userPositionAllColumns
	} else {
